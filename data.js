const translations = {
    ...
    fr: {
        ...
        hero_subtitle: "Étudiant ingénieur à l'EMINES-UM6P spécialisé en Management Industrielle, passionné par l'Optimisation, la Science des Données et l'utilisation de la technologie pour résoudre des défis concrets.",
        hero_cta_button: "Voir mes travaux",
        about_title: "À propos de moi",
        about_p1: "Bonjour ! Je suis Mohammed EL BARAKA, étudiant ingénieur en Management Industrielle à la prestigieuse Université Mohammed VI Polytechnique (UM6P). Mon parcours académique, débutant par un programme intensif en Mathématiques et Physique, m'a doté d'un solide esprit d'analyse et de résolution de problèmes.",
    ...
    ar: {
        ...
        hero_subtitle: "طالب هندسة في EMINES متخصص في التدبير الصناعي وشغوف بعلوم البيانات وتسخير التكنولوجيا لمواجهة تحديات العالم الحقيقي.",
        hero_cta_button: "اكتشف أعمالي",
        about_title: "عني",
        about_p1: "مرحباً! أنا محمد البركا، طالب هندسة في التدبير الصناعي بجامعة محمد السادس للفنون التطبيقية (UM6P) المرموقة. رحلتي الأكاديمية، التي بدأت ببرنامج مكثف في الرياضيات والفيزياء، غرست فيّ عقلية تحليلية قوية وقدرة على حل المشكلات.",
    ...
    de: {
        ...
        hero_subtitle: "Ein Wirtschaftsingenieur-Student an der EMINES-UM6P, spezialisiert auf Industrielles Management, mit einer Leidenschaft für Optimierung, Datenwissenschaft und den Einsatz von Technologie zur Lösung realer Herausforderungen.",
        hero_cta_button: "Meine Arbeit ansehen",
        about_title: "Über mich",
        about_p1: "Hallo! Ich bin Mohammed EL BARAKA, ein Wirtschaftsingenieur-Student an der renommierten Mohammed VI Polytechnic University (UM6P). Mein akademischer Weg, der mit einem intensiven Vorbereitungsprogramm in Mathematik und Physik begann, hat mir ein starkes analytisches Denken und Problemlösungskompetenz verliehen.",
